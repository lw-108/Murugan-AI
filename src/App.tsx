    ...
    <div className="relative min-h-screen text-slate-800 font-sans antialiased">
      ...
      <header className="sticky top-0 z-50 w-full transition-all backdrop-blur-md">
        <div className="w-full max-w-[1920px] mx-auto px-3 sm:px-4 md:px-6 py-2 sm:py-3 md:py-4">
          ...
          <div className="lg:hidden">
            ...
            <div className="flex items-center justify-between w-full">
              <div className="flex items-center gap-2 select-none shrink-0">
                <img src="/logo.svg" alt="Murugan AI" className="h-6 sm:h-7 md:h-8 w-auto object-contain" />
              </div>
              <div className="flex items-center shrink-0">
                <div className="w-7 h-7 sm:w-8 sm:h-8 md:w-9 md:h-9 rounded-full overflow-hidden border border-slate-200/80 shadow-sm bg-white flex items-center justify-center p-0.5 cursor-pointer hover:opacity-90 transition-opacity">
                  <img src={profileImage} alt="Avatar" className="w-full h-full object-cover rounded-full" />
                </div>
              </div>
            </div>

            {/* Bottom row: Navbar + Search icon centered */}
              ...
              <nav className="flex items-center gap-0.5 sm:gap-1 bg-white p-1 rounded-full border border-slate-200/80 shadow-sm">
                {["Dashboard", "Applications", "DUT", "Configuration"].map((item) => (
                  <button
                    ...
                    className={`px-2 sm:px-3 md:px-4 py-1 sm:py-1.5 md:py-2 rounded-full text-[10px] sm:text-xs md:text-sm font-semibold transition-all duration-200 whitespace-nowrap ${activeNav === item
                ...
                {/* Search icon merged with navbar */}
                <div className="h-4 w-px bg-slate-200 mx-0.5 sm:mx-1 shrink-0" />
                <button
                  title="Search"
                  className="p-1.5 sm:p-2 rounded-full text-slate-500 hover:text-slate-900 hover:bg-slate-100 transition-all shrink-0 flex items-center justify-center"
                >
          ...
          {/* Desktop Layout: Single row - Logo left | Nav center | Search near nav right | Profile far right */}
          <div className="hidden lg:flex items-center justify-between w-full">
            {/* Logo - Left */}
            <div className="flex items-center gap-2 select-none shrink-0">
              <img src="/logo.svg" alt="Murugan AI" className="h-8 lg:h-9 w-auto object-contain" />
            </div>
            ...
            <div className="flex items-center gap-2 lg:gap-3 flex-1 justify-center">
              <nav className="flex items-center gap-0.5 sm:gap-1 bg-white p-1 rounded-full border border-slate-200/80 shadow-sm">
                {["Dashboard", "Applications", "DUT", "Configuration"].map((item) => (
                  <button
                    key={item}
                    onClick={() => setActiveNav(item)}
                    className={`px-3 md:px-4 py-1.5 md:py-2 rounded-full text-sm lg:text-base font-semibold transition-all duration-200 whitespace-nowrap ${activeNav === item
                        ? "bg-[#004FEC] text-white shadow-sm"
                        : "text-slate-600 hover:text-slate-900 hover:bg-slate-50"
                      }`}
                  >
              ...
              {/* Search icon - Detached from navbar */}
              <button
                title="Search"
                className="flex rounded-full bg-white border border-slate-200/80 shadow-sm hover:bg-slate-50 transition-all items-center justify-center cursor-pointer shrink-0 h-[52px] w-[52px]"
              >
            ...
            {/* Profile - Right end */}
            <div className="flex items-center shrink-0">
              <div className="w-10 h-10 rounded-full overflow-hidden border border-slate-200/80 shadow-sm bg-white flex items-center justify-center p-0.5 cursor-pointer hover:opacity-90 transition-opacity">
                <img src={profileImage} alt="Avatar" className="w-full h-full object-cover rounded-full" />
              </div>
            </div>
          </div>
